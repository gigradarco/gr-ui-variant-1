...
import { tasteIdentityTags } from '../../data/profileIdentity'
import { useAppState } from '../../store/appStore'

export function ProfileTasteIdentityScreen() {
  const { closeProfileTasteAll } = useAppState()
  ...
  return (
    ...
    >
      <header className="profile-list-screen-header">
        ...
        <h1 className="profile-list-screen-title">Taste identity</h1>
